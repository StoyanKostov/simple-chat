          ...
          __tag(out,
            ...
            function(out) {
              out.w('<h3>' +
                ...
                '</h5><form method="POST" action="register-user"><label>Choose your username <input name="username" type="text"></label><label>Create a password <input name="password" type="text"></label><label>Confirm your password <input name="passwordRe" type="text"></label><input type="submit"></form>');
            });
        }
      });
  };
